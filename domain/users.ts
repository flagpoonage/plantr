...
export const createUserSchema = Joi.object<CreateUserDto>({
  ...
  username: Joi.string().min(rules.username.minLength.value).max(rules.username.maxLength.value).messages({
  ...
  password: Joi.string().min(rules.password.minLength.value).max(rules.password.maxLength.value).messages({
